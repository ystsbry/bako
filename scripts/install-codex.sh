#!/usr/bin/env bash
#
# Install bako's skills for the OpenAI Codex CLI.
#
...
Installed bako skills as Codex CLI skills.
Restart Codex to pick them up, then invoke with:

  \$register-repo --project <slug|name> --repo <owner/name> [--path <REPO_DIR>]
EOF
fi
